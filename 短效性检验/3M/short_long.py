...
def run_did_analysis(traffic_path, factors_path, treat_path, output_dir):
    ...
    # 建立回归模型
    formula = "ACCIDENT_RATE ~ TREAT_POLICY + POLICY + TREAT_POLICY_INTERACT + C(COD_BAR, Treatment(1)) + C(DATE, Treatment(1))"
    ...
    output_path = os.path.join(output_dir, f"DID_results_3M_O_{timestamp}.xlsx")
...
# 示例调用
run_did_analysis("0225 Long-Short/3M/TrafficAccident_22.xlsx", 
                 "0225 Long-Short/3M/CONTROL_ADD_22.xlsx", 
                 "0225 Long-Short/3M/MARK_22.xlsx", 
                 "0225 Long-Short/did_output_22")
